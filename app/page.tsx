      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <tbody>
                  {estadisticas.map((jugador, index) => (
                    ...
                    >
                      ...
                      <td className="border border-modern-border/30 p-3 font-semibold bg-gradient-to-r from-modern-accent to-modern-accent2 bg-clip-text text-transparent">
        ...
        <div className="text-center mt-8 text-modern-textSecondary">
          <p className="flex items-center justify-center gap-2">
            ...
            Liga Neoegoísta - Sistema de gestión moderna conectado a API
            <Zap className="h-4 w-4 text-modern-accent" />
          </p>
        </div>
      </div>
